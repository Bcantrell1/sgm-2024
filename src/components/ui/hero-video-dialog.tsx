        ...
        {isVideoOpen && (
          ...
          >
            <motion.div
              ...
              className="relative w-full h-2/3 max-w-4xl aspect-video mx-4 md:mx-0"
            >
              ...
              <div className="size-full border-2 border-green-500 rounded-2xl overflow-hidden isolate z-[1] relative">
                <iframe
                  src={videoSrc}
